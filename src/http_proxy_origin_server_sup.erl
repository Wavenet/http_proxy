%%% http_proxy_origin_server_sup.erl
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%
-module(http_proxy_origin_server_sup).
...
%%
init(Args) ->
	ChildSpecs = [server(http_proxy_origin_server, Args),
			supervisor(http_proxy_origin_connect_sup, [])],

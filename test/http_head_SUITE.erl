...
init_per_suite(Config) ->
	...
	ok = inets:start(),
	Config2 = http_test_lib:start_origin(Config1, [{modules, [mod_head]}]),
...
all() ->
	[head, accept_html, accept_text, noexist, nodir].
...
head(Config) ->
	...
	ok = gen_tcp:send(Socket, ["HEAD /", FileName, " HTTP/1.1", [13, 10],

...
suite() ->
	[{userdata, [{info, "This suite tests the HTTP DELETE method"}]},
...
init_per_suite(Config) ->
	...
	ok = inets:start(),
	Config2 = http_test_lib:start_origin(Config1, [{modules, [mod_delete]}]),
...
all() ->
	[delete, noexist, nodir].

delete() ->
	[{userdata, [{doc, "Test the DELETE method in simplest form"}]}].
